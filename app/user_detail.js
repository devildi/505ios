    ...
    return( 
      <View style={styles.container}>
        ...
        <View style={styles.baseBox}>
          <View style={styles.base}><Text style={styles.baseText}>吳迪(002180)</Text></View>
          <View style={styles.base}><Text style={styles.baseText}>網絡數據部</Text></View>
        </View>
        <View style={styles.baseBox}>
          <View style={styles.base}><Text style={styles.baseText}>電視大廈505</Text></View>
          <View style={styles.base}><Text style={styles.baseText}>15099945454</Text></View>
        </View>
